        ...
        {!selectedQuiz ? (
          <>
            ...
            {loading ? (
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                {quizzes.map(quiz => (
                  <div key={quiz._id} className="glass rounded-xl p-6 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
          ...
          <div className="glass rounded-xl p-6 md:p-8">
            ...
            <div className="space-y-4">
              {results.map((r, idx) => (
                <div key={idx} className={`p-4 rounded-lg ${r.isCorrect ? 'bg-green-500/20 border border-green-500' : 'bg-red-500/20 border border-red-500'}`}>
          ...
          <div className="glass rounded-xl p-6 md:p-8">
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6">
              <div>
                <h2 className="text-2xl font-bold text-white mb-1">{selectedQuiz.title}</h2>
                <p className="text-white/70 text-sm">{selectedQuiz.description}</p>
              </div>
